...
#[AsController]
class RemoveFavDrink extends AbstractController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        return new JsonResponse([
            "statusCode" => 200,
            "message" => sprintf("Drink with id %s removed from user %s favourites", $cocktailId, $user->getEmail())
        ]);
    }
}