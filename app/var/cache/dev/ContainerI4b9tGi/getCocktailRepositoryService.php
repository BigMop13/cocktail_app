 ...
 */
class getCocktailRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CocktailRepository' shared autowired service.
     *
     * @return \App\Repository\CocktailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CocktailRepository.php';

        return $container->privates['App\\Repository\\CocktailRepository'] = new \App\Repository\CocktailRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
